...
return [
    ...
    | múltiples, como las reglas de tamaño. Siéntete libre de personalizar
    ...
    */
    ...
    'alpha_num' => 'El campo :attribute debe contener letras y números solamente.',
    ...
    | Esto hace que sea rápido especificar una línea de idioma específica
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para cambiar nuestros marcadores de posición de atributo
